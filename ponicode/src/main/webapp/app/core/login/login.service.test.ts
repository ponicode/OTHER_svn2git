...
describe("loginWithToken", () => {
    ...
    beforeEach(() => {
        ...
        inst4 = new translate_parser.TranslateParser()
        inst5 = new missing_translation_handler.MissingTranslationHandler()
        inst6 = new core.TranslateService(inst, inst2, inst3, inst4, inst5, false, true)
        inst7 = new config_service.JhiConfigService(undefined)
        inst8 = new ng_jhipster.JhiLanguageService(inst6, inst7)
        inst9 = new http.HttpHandler()
        inst10 = new http.HttpClient(inst9)
        ...
        inst16 = new rxjs.Observable(undefined)
        inst15 = new rxjs.Subject()
        inst17 = new ngx_webstorage.LocalStorageService({ keyChanges: inst15, isAvailable: false, name: "Edmond", get: () => inst16, set: () => null, del: () => null, clear: () => null })
        inst18 = new auth_jwt_service.AuthServerProvider(inst14, inst17, class_transformer.plainToClass(ngx_webstorage.SessionStorageService,{}))
        inst19 = new login_service.LoginService(inst8, inst12, inst18)
    })
    ...
    test("1", () => {
        let result: any = inst19.loginWithToken("http://www.example.com/route/123?foo=bar", "v4.0.0-rc.4")
        expect(result).toMatchSnapshot()
    })

    test("2", () => {
        let result: any = inst19.loginWithToken("https://api.telegram.org/", "4.0.0-beta1\t")
        expect(result).toMatchSnapshot()
    })

    test("3", () => {
        let result: any = inst19.loginWithToken("Www.GooGle.com", "v1.2.4")
        expect(result).toMatchSnapshot()
    })

    test("4", () => {
        let result: any = inst19.loginWithToken("https://", "1.0.0")
        expect(result).toMatchSnapshot()
    })
...
describe("logout", () => {
    ...
    beforeEach(() => {
        ...
        inst16 = new rxjs.Observable(undefined)
        inst15 = new rxjs.Subject()
        inst17 = new ngx_webstorage.LocalStorageService({ keyChanges: inst15, isAvailable: false, name: "Anas", get: () => inst16, set: () => null, del: () => null, clear: () => null })
        inst18 = new auth_jwt_service.AuthServerProvider(inst14, inst17, class_transformer.plainToClass(ngx_webstorage.SessionStorageService,{}))
        inst19 = new login_service.LoginService(inst8, inst12, inst18)
    })
