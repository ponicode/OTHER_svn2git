...
describe("register", () => {
    ...
    beforeEach(() => {
        ...
        inst5 = new translate_parser.TranslateParser()
        inst6 = new missing_translation_handler.MissingTranslationHandler()
        inst7 = new core.TranslateService(inst2, inst3, inst4, inst5, inst6, false, false)
        inst8 = new config_service.JhiConfigService(undefined)
        inst9 = new ng_jhipster.JhiLanguageService(inst7, inst8)
        inst10 = new http.HttpHandler()
        inst11 = new http.HttpClient(inst10)
        ...
        inst15 = new rxjs.Observable(undefined)
        inst14 = new rxjs.Subject()
        inst16 = new ngx_webstorage.LocalStorageService({ keyChanges: inst14, isAvailable: false, name: "George", get: () => inst15, set: () => null, del: () => null, clear: () => null })
        inst17 = new auth_jwt_service.AuthServerProvider(null, inst16, class_transformer.plainToClass(ngx_webstorage.SessionStorageService,{}))
        inst18 = new login_service.LoginService(inst9, inst13, inst17)
        inst21 = new rxjs.Observable(undefined)
        inst20 = new rxjs.Observable(undefined)
        inst19 = new rxjs.Subject()
        inst22 = new ngx_webstorage.SessionStorageService({ keyChanges: inst19, isAvailable: false, name: "Edmond", get: () => inst20, set: () => null, del: () => inst21, clear: () => null })
        inst23 = new state_storage_service.StateStorageService(inst22)
        inst24 = new core.ElementRef("a1969970175")
        inst25 = new core.Renderer()
        inst26 = new url_tree.UrlSerializer()
        inst27 = new router_outlet_context.ChildrenOutletContexts()
        inst28 = new location_strategy.LocationStrategy()
        inst29 = new location.Location(inst28)
        object = [["[-1, 0.5, 1, 2, 3, 4, 5]", "[-1, 0.5, 1, 2, 3, 4, 5]", "[-1, 0.5, 1, 2, 3, 4, 5]", "[\"a\", \"b\", \"043\", \"holasenior\"]", "[\"a\", \"b\", \"043\", \"holasenior\"]"], ["[-1, 0.5, 1, 2, 3, 4, 5]", "[-1, 0.5, 1, 2, 3, 4, 5]", "[-1, 0.5, 1, 2, 3, 4, 5]", "[\"a\", \"b\", \"043\", \"holasenior\"]", "[\"a\", \"b\", \"043\", \"holasenior\"]"], ["[-1, 0.5, 1, 2, 3, 4, 5]", "[\"foo bar\",  -0.353, \"**text**\", 4653]", "[10, -45.9, 103.5, 0.955674]", "[-1, 0.5, 1, 2, 3, 4, 5]", "[10, -45.9, 103.5, 0.955674]"]]
        inst30 = new ng_module_factory_loader.NgModuleFactoryLoader()
        inst31 = new compiler.Compiler()
        object2 = [{ path: undefined, pathMatch: "C:\\\\path\\to\\file.ext", matcher: undefined, component: undefined, redirectTo: "https://croplands.org/app/a/reset?token=", outlet: "Small Cotton Chips", canActivate: undefined, canActivateChild: undefined, canDeactivate: undefined, canLoad: undefined, data: undefined, resolve: undefined, children: undefined, loadChildren: "9876", runGuardsAndResolvers: "always" }, { path: undefined, pathMatch: "/path/to/file", matcher: undefined, component: undefined, redirectTo: "https://", outlet: "Awesome Frozen Computer", canActivate: undefined, canActivateChild: undefined, canDeactivate: undefined, canLoad: undefined, data: undefined, resolve: undefined, children: undefined, loadChildren: "da7588892", runGuardsAndResolvers: "always" }, { path: undefined, pathMatch: "C:\\\\path\\to\\file.ext", matcher: undefined, component: undefined, redirectTo: "https://twitter.com/path?abc", outlet: "Handmade Fresh Chicken", canActivate: undefined, canActivateChild: undefined, canDeactivate: undefined, canLoad: undefined, data: undefined, resolve: undefined, children: undefined, loadChildren: "12345", runGuardsAndResolvers: "always" }]
        inst32 = new router.Router(null, inst26, inst27, inst29, core.Injector.create(object,undefined), inst30, inst31, object2)
        inst33 = new ng_bootstrap.NgbActiveModal()
        inst34 = new login_component.JhiLoginModalComponent(inst, inst18, inst23, inst24, inst25, inst32, inst33)
    })

    test("0", () => {
        let result: any = inst34.register()
        expect(result).toMatchSnapshot()
    })
})
