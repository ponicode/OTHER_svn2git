...
describe("trackId", () => {
    ...
    test("0", () => {
        let result: any = inst18.trackId(-100, { id: undefined, svnDirectory: undefined, regex: undefined, gitDirectory: "/usr/share", svnDirectoryDelete: undefined })
        expect(result).toMatchSnapshot()
    })

    test("1", () => {
        let result: any = inst18.trackId(1, { id: -100, svnDirectory: undefined, regex: undefined, gitDirectory: undefined, svnDirectoryDelete: undefined })
        expect(result).toMatchSnapshot()
    })

    test("2", () => {
        let result: any = inst18.trackId(1, { id: undefined, svnDirectory: undefined, regex: undefined, gitDirectory: "/usr/share", svnDirectoryDelete: undefined })
        expect(result).toMatchSnapshot()
    })

    test("3", () => {
        let result: any = inst18.trackId(1, { id: undefined, svnDirectory: undefined, regex: "(definition-(checksum|signature)\\s[\\w=\\/+]+)", gitDirectory: "/usr/share", svnDirectoryDelete: undefined })
        expect(result).toMatchSnapshot()
    })

    test("4", () => {
        let result: any = inst18.trackId(-1, { id: -5.48, svnDirectory: undefined, regex: undefined, gitDirectory: undefined, svnDirectoryDelete: undefined })
        expect(result).toMatchSnapshot()
    })

    test("5", () => {
        let result: any = inst18.trackId(NaN, { id: undefined, svnDirectory: undefined, regex: undefined, gitDirectory: undefined, svnDirectoryDelete: undefined })
        expect(result).toMatchSnapshot()
    })
})
