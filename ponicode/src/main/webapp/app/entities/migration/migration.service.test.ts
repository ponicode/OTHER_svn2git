...
describe("create", () => {
    ...
    test("0", () => {
        let result: any = inst3.create({ id: undefined, svnGroup: undefined, svnProject: "C:\\\\path\\to\\folder\\", user: "Pierre Edouard", date: undefined, gitlabGroup: undefined, gitlabProject: "path/to/file.ext", status: undefined, maxFileSize: "43083", forbiddenFileExtensions: "m2v", gitlabUrl: undefined, gitlabToken: undefined, svnUrl: "http://www.example.com/route/123?foo=bar", svnUser: "Michael", svnPassword: undefined, svnRevision: "MPZf3hhgRxurYDDVsHhDc23nDi", trunk: undefined, branches: "protocol-reboot", tags: undefined, svnHistory: undefined, tagsToMigrate: "1.0.0", branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: undefined, histories: undefined, mappings: undefined, flat: undefined, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })

    test("1", () => {
        let result: any = inst3.create({ id: 100, svnGroup: "da7588892", svnProject: undefined, user: undefined, date: undefined, gitlabGroup: undefined, gitlabProject: "path/to/folder/", status: undefined, maxFileSize: "44074", forbiddenFileExtensions: "mpe", gitlabUrl: "ponicode.com", gitlabToken: undefined, svnUrl: undefined, svnUser: undefined, svnPassword: "^5.0.0", svnRevision: "3cBk3sCzB58vfDGAznLJK9KPSnW1", trunk: undefined, branches: undefined, tags: "Kailey Bypass", svnHistory: undefined, tagsToMigrate: undefined, branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: "/usr/share", emptyDirs: undefined, histories: undefined, mappings: undefined, flat: false, uploadType: "Developer" })
        expect(result).toMatchSnapshot()
    })

    test("2", () => {
        let result: any = inst3.create({ id: undefined, svnGroup: "c466a48309794261b64a4f02cfcc3d64", svnProject: "path/to/folder/", user: undefined, date: undefined, gitlabGroup: "bc23a9d531064583ace8f67dad60f6bb", gitlabProject: undefined, status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "pdf", gitlabUrl: undefined, gitlabToken: undefined, svnUrl: undefined, svnUser: undefined, svnPassword: undefined, svnRevision: undefined, trunk: undefined, branches: undefined, tags: "Clement Cliffs", svnHistory: undefined, tagsToMigrate: undefined, branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: undefined, histories: undefined, mappings: undefined, flat: undefined, uploadType: "Producer" })
        expect(result).toMatchSnapshot()
    })

    test("3", () => {
        let result: any = inst3.create({ id: undefined, svnGroup: "12345", svnProject: "./path/to/file", user: undefined, date: undefined, gitlabGroup: "da7588892", gitlabProject: undefined, status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "pdf", gitlabUrl: undefined, gitlabToken: undefined, svnUrl: undefined, svnUser: undefined, svnPassword: undefined, svnRevision: undefined, trunk: undefined, branches: undefined, tags: "Corrine Square", svnHistory: undefined, tagsToMigrate: undefined, branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: undefined, histories: undefined, mappings: undefined, flat: undefined, uploadType: "Developer" })
        expect(result).toMatchSnapshot()
    })

    test("4", () => {
        let result: any = inst3.create({ id: -100, svnGroup: "c466a48309794261b64a4f02cfcc3d64", svnProject: undefined, user: undefined, date: undefined, gitlabGroup: undefined, gitlabProject: "C:\\\\path\\to\\file.ext", status: undefined, maxFileSize: "59089", forbiddenFileExtensions: "pdf", gitlabUrl: "ponicode.com", gitlabToken: undefined, svnUrl: undefined, svnUser: undefined, svnPassword: "v1.2.4", svnRevision: "Lq8wLspXaJraZSs3CwiCTF85mkvp", trunk: undefined, branches: undefined, tags: "Clement Cliffs", svnHistory: undefined, tagsToMigrate: undefined, branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: "/selinux", emptyDirs: undefined, histories: undefined, mappings: undefined, flat: false, uploadType: "Architect" })
        expect(result).toMatchSnapshot()
    })

    test("5", () => {
        let result: any = inst3.create({ id: -Infinity, svnGroup: undefined, svnProject: undefined, user: undefined, date: undefined, gitlabGroup: "", gitlabProject: "", status: undefined, maxFileSize: "", forbiddenFileExtensions: undefined, gitlabUrl: undefined, gitlabToken: undefined, svnUrl: "", svnUser: undefined, svnPassword: "", svnRevision: undefined, trunk: undefined, branches: undefined, tags: "", svnHistory: "", tagsToMigrate: "", branchesToMigrate: "", createdTimestamp: undefined, workingDirectory: "", emptyDirs: undefined, histories: undefined, mappings: undefined, flat: false, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })
})
...
describe("retry", () => {
    ...
    test("2", () => {
        let result: any = inst3.retry(-100, true)
        expect(result).toMatchSnapshot()
    })
    ...
    test("5", () => {
        let result: any = inst3.retry(-Infinity, false)
        expect(result).toMatchSnapshot()
    })
})
...
describe("update", () => {
    ...
    test("0", () => {
        let result: any = inst3.update({ id: 1, svnGroup: "9876", svnProject: "C:\\\\path\\to\\folder\\", user: "Michael", date: undefined, gitlabGroup: "c466a48309794261b64a4f02cfcc3d64", gitlabProject: "C:\\\\path\\to\\file.ext", status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "pdf", gitlabUrl: "https://croplands.org/app/a/confirm?t=", gitlabToken: "oAuthToken", svnUrl: "https://api.telegram.org/bot", svnUser: undefined, svnPassword: "v1.2.4", svnRevision: undefined, trunk: undefined, branches: "port-generate", tags: undefined, svnHistory: undefined, tagsToMigrate: "^5.0.0", branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: true, histories: undefined, mappings: undefined, flat: false, uploadType: "Developer" })
        expect(result).toMatchSnapshot()
    })

    test("1", () => {
        let result: any = inst3.update({ id: 1, svnGroup: "c466a48309794261b64a4f02cfcc3d64", svnProject: undefined, user: "Edmond", date: undefined, gitlabGroup: undefined, gitlabProject: undefined, status: undefined, maxFileSize: "59089", forbiddenFileExtensions: undefined, gitlabUrl: undefined, gitlabToken: "oAuthToken", svnUrl: undefined, svnUser: undefined, svnPassword: undefined, svnRevision: undefined, trunk: "pdf", branches: "port-generate", tags: undefined, svnHistory: "c466a48309794261b64a4f02cfcc3d64", tagsToMigrate: undefined, branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: true, histories: undefined, mappings: undefined, flat: undefined, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })

    test("2", () => {
        let result: any = inst3.update({ id: -100, svnGroup: "bc23a9d531064583ace8f67dad60f6bb", svnProject: "C:\\\\path\\to\\file.ext", user: "George", date: undefined, gitlabGroup: "da7588892", gitlabProject: "C:\\\\path\\to\\folder\\", status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "pdf", gitlabUrl: "https://api.telegram.org/bot", gitlabToken: "oAuthToken", svnUrl: "http://base.com", svnUser: undefined, svnPassword: "4.0.0-beta1\t", svnRevision: undefined, trunk: undefined, branches: "microchip-bypass", tags: undefined, svnHistory: undefined, tagsToMigrate: "v4.0.0-rc.4", branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: true, histories: undefined, mappings: undefined, flat: false, uploadType: "Architect" })
        expect(result).toMatchSnapshot()
    })

    test("3", () => {
        let result: any = inst3.update({ id: -5.48, svnGroup: "c466a48309794261b64a4f02cfcc3d64", svnProject: undefined, user: "George", date: undefined, gitlabGroup: undefined, gitlabProject: undefined, status: undefined, maxFileSize: "44074", forbiddenFileExtensions: undefined, gitlabUrl: undefined, gitlabToken: "u7djsl186ksk99-DsklLk89", svnUrl: undefined, svnUser: undefined, svnPassword: undefined, svnRevision: undefined, trunk: "jpeg", branches: "matrix-input", tags: undefined, svnHistory: "bc23a9d531064583ace8f67dad60f6bb", tagsToMigrate: undefined, branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: true, histories: undefined, mappings: undefined, flat: undefined, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })

    test("4", () => {
        let result: any = inst3.update({ id: 0, svnGroup: "da7588892", svnProject: undefined, user: undefined, date: undefined, gitlabGroup: "12345", gitlabProject: undefined, status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "m2v", gitlabUrl: undefined, gitlabToken: undefined, svnUrl: "https://api.telegram.org/", svnUser: "Anas", svnPassword: "v1.2.4", svnRevision: undefined, trunk: undefined, branches: undefined, tags: undefined, svnHistory: "c466a48309794261b64a4f02cfcc3d64", tagsToMigrate: undefined, branchesToMigrate: "v1.2.4", createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: true, histories: undefined, mappings: undefined, flat: true, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })

    test("5", () => {
        let result: any = inst3.update({ id: undefined, svnGroup: undefined, svnProject: undefined, user: "", date: undefined, gitlabGroup: "", gitlabProject: undefined, status: undefined, maxFileSize: undefined, forbiddenFileExtensions: undefined, gitlabUrl: undefined, gitlabToken: undefined, svnUrl: undefined, svnUser: undefined, svnPassword: "", svnRevision: "", trunk: undefined, branches: undefined, tags: undefined, svnHistory: "", tagsToMigrate: "", branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: true, histories: undefined, mappings: undefined, flat: undefined, uploadType: "" })
        expect(result).toMatchSnapshot()
    })
})
...
describe("findMappings", () => {
    ...
    test("1", () => {
        let result: any = inst3.findMappings(-5.48)
        expect(result).toMatchSnapshot()
    })
...
describe("convertDateFromClient", () => {
    ...
    test("0", () => {
        let result: any = inst3.convertDateFromClient({ id: -100, svnGroup: undefined, svnProject: "path/to/file.ext", user: "Anas", date: undefined, gitlabGroup: undefined, gitlabProject: undefined, status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "m2v", gitlabUrl: "ponicode.com", gitlabToken: "u7djsl186ksk99-DsklLk89", svnUrl: "https://", svnUser: "Anas", svnPassword: "4.0.0-beta1\t", svnRevision: "MPZf3hhgRxurYDDVsHhDc23nDi", trunk: "pdf", branches: "port-generate", tags: "Kailey Bypass", svnHistory: "c466a48309794261b64a4f02cfcc3d64", tagsToMigrate: undefined, branchesToMigrate: "1.0.0", createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: false, histories: undefined, mappings: undefined, flat: true, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })

    test("1", () => {
        let result: any = inst3.convertDateFromClient({ id: 100, svnGroup: "da7588892", svnProject: undefined, user: "Anas", date: undefined, gitlabGroup: "9876", gitlabProject: "C:\\\\path\\to\\file.ext", status: undefined, maxFileSize: undefined, forbiddenFileExtensions: undefined, gitlabUrl: "Www.GooGle.com", gitlabToken: undefined, svnUrl: "https://", svnUser: undefined, svnPassword: "v4.0.0-rc.4", svnRevision: "3pxicLBUuEs8qDUKmTABBcWrxzf", trunk: "pdf", branches: undefined, tags: "Renner Circle", svnHistory: "12345", tagsToMigrate: "4.0.0-beta1\t", branchesToMigrate: "v1.2.4", createdTimestamp: undefined, workingDirectory: "/opt/share", emptyDirs: false, histories: undefined, mappings: undefined, flat: false, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })

    test("2", () => {
        let result: any = inst3.convertDateFromClient({ id: 100, svnGroup: "9876", svnProject: undefined, user: undefined, date: undefined, gitlabGroup: "bc23a9d531064583ace8f67dad60f6bb", gitlabProject: ".", status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "jpeg", gitlabUrl: "www.google.com", gitlabToken: undefined, svnUrl: "http://example.com/showcalendar.html?token=CKF50YzIHxCTKMAg", svnUser: "Edmond", svnPassword: "4.0.0-beta1\t", svnRevision: undefined, trunk: "jpeg", branches: "sensor-copy", tags: undefined, svnHistory: "bc23a9d531064583ace8f67dad60f6bb", tagsToMigrate: undefined, branchesToMigrate: "v4.0.0-rc.4", createdTimestamp: undefined, workingDirectory: "/selinux", emptyDirs: false, histories: undefined, mappings: undefined, flat: false, uploadType: "Manager" })
        expect(result).toMatchSnapshot()
    })

    test("3", () => {
        let result: any = inst3.convertDateFromClient({ id: undefined, svnGroup: "da7588892", svnProject: "/path/to/file", user: "Jean-Philippe", date: undefined, gitlabGroup: "9876", gitlabProject: "C:\\\\path\\to\\folder\\", status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "jpeg", gitlabUrl: undefined, gitlabToken: undefined, svnUrl: undefined, svnUser: "Jean-Philippe", svnPassword: "1.0.0", svnRevision: undefined, trunk: undefined, branches: undefined, tags: "Renner Circle", svnHistory: "c466a48309794261b64a4f02cfcc3d64", tagsToMigrate: undefined, branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: "/usr/sbin", emptyDirs: undefined, histories: undefined, mappings: undefined, flat: false, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })

    test("4", () => {
        let result: any = inst3.convertDateFromClient({ id: 1, svnGroup: undefined, svnProject: "C:\\\\path\\to\\file.ext", user: "Anas", date: undefined, gitlabGroup: undefined, gitlabProject: undefined, status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "jpeg", gitlabUrl: "https://api.telegram.org/bot", gitlabToken: "oAuthToken", svnUrl: "http://example.com/showcalendar.html?token=CKF50YzIHxCTKMAg", svnUser: "George", svnPassword: "v4.0.0-rc.4", svnRevision: "3cBk3sCzB58vfDGAznLJK9KPSnW1", trunk: "jpeg", branches: "protocol-reboot", tags: "Kailey Bypass", svnHistory: "9876", tagsToMigrate: undefined, branchesToMigrate: "v4.0.0-rc.4", createdTimestamp: undefined, workingDirectory: undefined, emptyDirs: false, histories: undefined, mappings: undefined, flat: true, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })

    test("5", () => {
        let result: any = inst3.convertDateFromClient({ id: undefined, svnGroup: "", svnProject: "", user: "", date: undefined, gitlabGroup: "", gitlabProject: "", status: undefined, maxFileSize: undefined, forbiddenFileExtensions: "", gitlabUrl: undefined, gitlabToken: undefined, svnUrl: undefined, svnUser: "", svnPassword: "", svnRevision: undefined, trunk: undefined, branches: undefined, tags: "", svnHistory: "", tagsToMigrate: undefined, branchesToMigrate: undefined, createdTimestamp: undefined, workingDirectory: "", emptyDirs: undefined, histories: undefined, mappings: undefined, flat: false, uploadType: undefined })
        expect(result).toMatchSnapshot()
    })
})
